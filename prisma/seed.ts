...
async function main() {
  ...
  const org = await db.organization.create({
    data: {
      ...
      supportEmail: "people@meridianlabs.example",
      // Printed on every generated letter. No logo is seeded — uploading one at
      // Settings → Letterhead is part of what there is to try.
      letterheadAddress:
        "4th Floor, Prestige Tower\nMG Road, Bengaluru 560001\nKarnataka, India",
      signatoryName: "Ananya Rao",
  ...
  // --- letter templates --------------------------------------------------
  // Starter templates so the Documents module has something to generate from
  // on a fresh clone. Each one is ordinary markdown with {{tokens}}; variables
  // whose `source` is set fill themselves in when an employee is picked.
    ...
    data: [
      {
        ...
        name: "Offer letter",
        kind: "offer",
        description: "For candidates accepting a full-time role.",
        subject: "Offer of employment — {{candidateName}}",
        ...
        variables: [
          ...
          { key: "annualCtc", label: "Annual CTC", type: "money", required: true },
          ...
          },
          {
            ...
            type: "date",
            required: true,
            helpText: "After this date the offer lapses.",
          },
        ],
        body: [
          "Dear {{candidateName}},",
          "",
          "We are delighted to offer you the position of **{{designation}}** in our {{department}} team at {{org.name}}.",
          "",
          "## Terms of the offer",
          "",
          "| | |",
          ...
          "| Annual cost to company | {{annualCtc}} |",
          "",
          "Your compensation is inclusive of all statutory employer contributions. A detailed breakdown will be shared along with your appointment letter.",
          "",
          "## Conditions",
          "",
          "- This offer is subject to satisfactory reference and background verification.",
          "- You confirm that joining us will not breach any obligation to a previous employer.",
          "- Either party may end the employment by serving the notice period stated in the appointment letter.",
          "",
          "Please confirm your acceptance by replying to this letter on or before **{{offerValidTill}}**. We are looking forward to working with you.",
          "",
          "Warm regards,",
        ].join("\n"),
      },
      {
        ...
        kind: "relieving",
        description: "Issued on the last working day, once clearance is complete.",
        ...
        variables: [
          ...
          },
          {
            ...
            type: "date",
            required: true,
            source: "employee.dateOfExit",
          },
        ],
        body: [
          "To whomsoever it may concern,",
          "",
          "This is to certify that **{{employeeName}}** (Employee ID {{employeeCode}}) was employed with {{org.name}} as **{{designation}}** from {{joiningDate}} to {{lastWorkingDay}}.",
          "",
          "Their resignation has been accepted and they have been relieved of their duties with effect from the close of business on {{lastWorkingDay}}. All company property in their possession has been returned and their dues have been settled in full.",
          "",
          "We confirm that there are no dues outstanding from either party, and we wish them every success in their future endeavours.",
          "",
          "Sincerely,",
        ].join("\n"),
      },
      {
        ...
        kind: "experience",
        description: "Confirms tenure and conduct. Safe to issue to any former employee.",
        ...
        variables: [
          ...
          },
          {
            ...
            type: "text",
            required: false,
            source: "employee.tenure",
          },
        ],
        body: [
          "To whomsoever it may concern,",
          "",
          "This is to certify that **{{employeeName}}** worked with {{org.name}} as **{{designation}}** in the {{department}} team from {{joiningDate}} to {{lastWorkingDay}}, a period of {{tenure}}.",
          "",
          "During their time with us they were found to be sincere, diligent and professional in their conduct. Their contribution to the team was valued by colleagues and managers alike.",
          "",
          "We wish them the very best in their future career.",
          "",
          "Sincerely,",
        ].join("\n"),
      },
      {
        ...
        kind: "increment",
        description: "Annual revision. Pulls the new CTC from the employee's record.",
        subject: "Revision in compensation — {{employeeName}}",
        createdById: adminUser.id,
        variables: [
          {
            key: "employeeName",
        ...
        body: [
          "Dear {{employeeName}},",
          "",
          "Following this year's performance review, we are pleased to confirm a revision in your compensation.",
          "",
          "With effect from **{{effectiveFrom}}**, your annual cost to company as **{{designation}}** will be **{{newCtc}}**.",
          "",
          "## Revised structure",
          "",
          "{{breakdown}}",
          "",
          "All other terms of your employment remain unchanged. Thank you for the work you have put in this year — it has not gone unnoticed.",
          "",
          "Warm regards,",
        ].join("\n"),
      },
  ...
  console.log("  letter templates: 4");
